        ...
        <div class="row h-100">
                ...
                <nav id="sidebar">
                    ...
                    <ul style="display:inline-table;" class="nav nav-pills nav-stacked ms-4 mt-3" >
                        <li class="mt-3 justify-content-center">
                            <a class="nav-link px-2 link-secondary " aria-current="page">Visualizar especialidade</a>
                        </li>
                        <li class="mt-3">
                            <a class="nav-link px-2 link-secondary active" aria-current="page">Adicionar especialidade</a>
                        </li>
                        <li class="mt-3">
            ...
            <div class="col-9">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 style="font-weight: bold;">Adicionar Especialidade</h2>
